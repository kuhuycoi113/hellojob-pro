...
interface ManagementFeeDialogProps {
  isOpen: boolean;
...
export function ManagementFeeDialog({ isOpen, onOpenChange, onSelect, onBack, lang }: ManagementFeeDialogProps) {
