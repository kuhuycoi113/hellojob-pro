  ...
  return (
    <>
        ...
        <div className="hidden md:flex items-center gap-1">
            <Button size="icon" variant="ghost" className="h-8 w-8 hover:bg-primary/10" onClick={handleChatClick}>
                <MessageSquare className="h-5 w-5 text-primary"/>
            </Button>
            <Button asChild variant="ghost" size="icon" className="h-8 w-8 hover:bg-purple-50">
            ...
            <Button asChild variant="ghost" size="icon" className="h-8 w-8 hover:bg-blue-50">
             ...
             <Button asChild variant="ghost" size="icon" className="h-8 w-8 hover:bg-green-50">
            ...
            <Popover>
                <PopoverTrigger asChild>
                    <div id="MB4NUT01" className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                        <Button size="icon" variant="ghost" className="h-8 w-8 bg-primary/10 text-primary hover:bg-primary/20">
                            <MessageSquare className="h-4 w-4"/>
                        </Button>
                         <Button size="icon" variant="ghost" className="h-8 w-8 hover:bg-purple-50">
                         ...
                         <Button size="icon" variant="ghost" className="h-8 w-8 hover:bg-green-50">
