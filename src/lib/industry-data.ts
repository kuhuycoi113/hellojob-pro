...
export const industriesByJobType: { [key: string]: Industry[] } = {
    'thuc-tap-sinh-ky-nang': [
      ...
      { name: 'Thực phẩm', slug: 'thuc-pham', termCode: '311', keywords: [
          ...
          'Chế biến gia cầm',
          'Chế biến sushi',
          'Chế biến thịt bò, lợn',
          'Chế biến thuỷ sản sống',
          'Chiết xuất thuỷ sản',
          'Cơm hộp',
          'Cơm nắm',
          'Cửa hàng siêu thị',
      ...
      { name: 'Sản xuất, dịch vụ tổng hợp', slug: 'san-xuat-dich-vu-tong-hop', termCode: '3261', keywords: [
          ...
          'Đục lỗ hộp in',
          'Đúc nhựa',
          'Đúc nhựa cán xếp chồng',
          'Đục nhựa ép phun',
          'Đúc nhựa nén',
          'Đúc nhựa thổi định hình',
          'Đúc nhựa thổi phồng',
          'Gia công đồ gia dụng',
          'Gia công ép đùn cao su',
          'Gia công sản phẩm gỗ',
          'Gỗ ép',
          'Hàng hóa hàng không',
          ...
          'Linh kiện ô tô',
          'Nặn gốm bằng bánh xoay',
          'Nhiên liệu rắn từ rác',
          'Sản xuất hộp bìa cứng',
          'Sản xuất hộp in',
          'Sản xuất hộp nhãn dán',
          'Sản xuất linh kiện',
          'Sản xuất pin năng lượng',
          'Sản xuất vải lanh',
          'Sửa chữa ô tô',
          'Thiết bị khí nén đường sắt',
          'Trộn và cán cao su',
      ...
      { name: 'Cơ khí, kim loại', slug: 'co-khi-kim-loai', termCode: '332710', keywords: [
          ...
          'Hàn tủ điện',
          'Hàn xì',
          'Hoàn thiện dụng cụ nung chảy',
          'Hoàn thiện khuôn',
          'Hoàn thiện sản phẩm ép đùn',
          'Kiểm tra máy móc',
          'Lắp đặt điều hoà',
          'Lắp đặt máy móc',
          'Lắp đặt tủ lạnh',
          ...
          'Lắp ráp thiết bị điện quay',
          'Lắp ráp thiết bị điện tử',
          'Lắp thiết bị đóng, mở',
          'Lắp tủ điện, tủ điều khiển',
          'Mạ điện',
          'Mạ kẽm nhúng nóng',
          'Máy sản xuất tấm kim loại',
          'Rèn',
          'Rèn bằng búa',
          'Sơn',
          'Sơn cầu thép',
      ...
      { name: 'Xây dựng', slug: 'xay-dung', termCode: '23', keywords: [
          ...
          'Gia công đường ống',
          'Gia công khung thép',
          'Gia công khung thép trong xưởng',
          'Gia công sắt trong xưởng',
          'Gia công vật liệu đá',
          'Hàn khung thép trên cao',
          'Hoàn thiện nội thất',
          'Hoàn thiện sàn nhựa',
          'Hoàn thiện sàn thảm',
          'Hoàn thiện ván',
          'Hút nước ngầm công trình',
          'Khoan giếng máy dập',
          'Khoan giếng máy khoan',
          'Khung chắn toà nhà',
          'Lái máy ủi',
          'Lái máy xây dựng',
          'Lái máy xúc',
          ...
          'Lắp bồn tắm',
          'Lắp đặt đường ống',
          'Lắp đặt lò nung-xây dựng',
          'Lắp đặt pin năng lượng',
          'Lắp điện lạnh, điều hòa',
          'Lắp ghép cốt thép',
          'Lát đá',
          'Lợp mái nhà',
          'Lợp ngói',
          'Mộc cốp pha',
          'Nội thất gỗ-xây dựng',
          'Ốp lát gạch',
          'Phá dỡ',
          'San lấp mặt bằng',
          'Sản xuất bê tông',
      ...
      { name: 'May mặc', slug: 'may-mac', termCode: '315', keywords: [
          ...
          'Sản xuất áo sơ mi',
          'Sản xuất đồ lót',
          'Sản xuất ghế ngồi ô tô',
          'Sản xuất máy dệt kim tròn',
          'Sản xuất tất',
          'Sản xuất thảm dệt',
          'Sản xuất thảm đục lỗ',
          'Sản xuất thảm nhung nổi',
          'Sản xuất vải bạt'
      ] }
    ],
    'ky-nang-dac-dinh': [
      { name: 'Ngư nghiệp', slug: 'ngu-nghiep', termCode: '11411', keywords: ['Nuôi trồng thủy sản', 'Đánh bắt cá'] },
      { name: 'Nông nghiệp', slug: 'nong-nghiep', termCode: '111', keywords: ['Trồng trọt', 'Chăn nuôi'] },
      { name: 'Nhà hàng', slug: 'nha-hang', termCode: '722511', keywords: ['Nấu ăn', 'Phục vụ', 'Quản lý nhà hàng'] },
      { name: 'Thực phẩm', slug: 'thuc-pham', termCode: '311', keywords: ['Chế biến thực phẩm', 'Đóng gói', 'Kiểm tra chất lượng'] },
      { name: 'Sản xuất, dịch vụ tổng hợp', slug: 'san-xuat-dich-vu-tong-hop', termCode: '31-33', keywords: ['Sản xuất', 'Lắp ráp', 'Đóng gói'] },
      { name: 'Điện, điện tử', slug: 'dien-dien-tu', termCode: '334', keywords: ['Lắp ráp linh kiện', 'Kiểm tra bảng mạch', 'Vận hành máy SMT'] },
      { name: 'Chế tạo Vật liệu', slug: 'che-tao-vat-lieu', termCode: '327', keywords: ['Đúc', 'Rèn', 'Xử lý nhiệt'] },
      { name: 'Cơ khí, chế tạo máy', slug: 'co-khi-che-tao-may', termCode: '333', keywords: ['Vận hành máy CNC', 'Hàn', 'Bảo trì máy móc'] },
      { name: 'Ô tô', slug: 'o-to', termCode: '336', keywords: ['Bảo dưỡng ô tô', 'Sửa chữa thân vỏ', 'Sơn ô tô'] },
      { name: 'Hàng không', slug: 'hang-khong', termCode: '4881', keywords: ['Dịch vụ mặt đất', 'Vệ sinh tàu bay', 'Bốc xếp hàng hóa'] },
      { name: 'Vận tải', slug: 'van-tai', termCode: '484', keywords: ['Lái xe', 'Giao nhận hàng hóa', 'Quản lý kho'] },
      { name: 'Xây dựng', slug: 'xay-dung', termCode: '23', keywords: ['Giàn giáo', 'Cốt thép', 'Cốp pha', 'Hoàn thiện nội thất'] },
      { name: 'Vệ sinh toà nhà', slug: 've-sinh-toa-nha', termCode: '561720', keywords: ['Vệ sinh toà nhà', 'Lau kính', 'Quản lý vệ sinh'] },
      { name: 'Lưu trú, khách sạn', slug: 'luu-tru-khach-san', termCode: '721', keywords: ['Lễ tân', 'Buồng phòng', 'Dịch vụ nhà hàng khách sạn'] },
      { name: 'Điều dưỡng', slug: 'dieu-duong', termCode: '623', keywords: ['Chăm sóc người cao tuổi', 'Hỗ trợ sinh hoạt', 'Hộ lý'] },
    ],
    'ky-su-tri-thuc': [
      ...
      { name: "Sản xuất, chế tạo, công nghệ", slug: "san-xuat-cong-nghe", termCode: '31-33', keywords: [
          ...
          "In ấn",
          "IT làm xưởng",
          "Khoan khảo sát dầu mỏ, năng lượng",
          "Kinh tế làm xưởng",
          "Lao động nước ngoài lĩnh vực sản xuất",
          "May mặc",
          "Môi trường làm xưởng",
          "Nhân viên sân bay",
          "Quản lý sản xuất tổng hợp",
          "Rác thải, phế liệu, tái chế",
          "Sản xuất sản phẩm",
      ...
      { name: "Cơ khí, máy móc", slug: "co-khi-may-moc", termCode: '332710', keywords: [
          ...
          "Cơ khí",
          "Công nghệ cơ khí",
          "Công nhân đóng tàu nước ngoài",
          "Công nhân sản xuất, gia công kim loại",
          "Điện cơ khí hỗ trợ chuyển nhà",
          "Điện nội thất",
          "Điện, kỹ thuật điện",
          "Gia công cơ khí",
          "Kiểm tra máy móc",
      ...
      { name: "Xây dựng", slug: "xay-dung", termCode: '23', keywords: [
          ...
          "Công nhân xây dựng (trừ khung công trình)",
          "Công nhân xây dựng mỏ tổng hợp",
          "Công nhân xây dựng nước ngoài",
          "Đường ống",
          "Giám sát thi công",
          "Hoàn thiện nội thất",
          "Khảo sát",
          ...
          "Kỹ thuật Khảo sát",
          "Kỹ thuật Kiến trúc",
          "Kỹ thuật Kiến trúc, Xây dựng, Khảo sát",
          "Kỹ thuật Xây dựng",
          "Nội thất gỗ",
      ...
      { name: "Y tế, điều dưỡng", slug: "y-te-dieu-duong", termCode: '62', keywords: [
          ...
          "Điều dưỡng dự bị học EPA",
          "Điều dưỡng, hộ lý EPA",
          "Điều dưỡng, hộ lý EPA dự bị",
          "Dược sĩ",
      ...
      { name: "Kinh doanh, kinh tế", slug: "kinh-doanh-kinh-te", termCode: '541611', keywords: [
          ...
          "Nhân viên dịch vụ khác (không phân loại nơi khác)",
          "Quản lý",
          "Quản lý kế hoạch quảng cáo, truyền thông",
      ...
      { name: "Công nghệ thông tin", slug: "it", termCode: '541511', keywords: [
          ...
          "ITM (Information Technical Manager)",
          "Lập trình nhúng",
          "Lập trình viên",
          "PM (Product Manager)",
          "PO (Product Owner)",
      ...
      { name: "Giáo dục, đào tạo", slug: "giao-duc-dao-tao", termCode: '61', keywords: [
          ...
          "Giảng dạy ngôn ngữ tại Tiểu học, THCS, PTTH",
          "Giảng dạy trường dạy nghề (Senmon)",
          "Giảng dạy trường học các loại",
          "Giảng dạy trường quốc tế",
