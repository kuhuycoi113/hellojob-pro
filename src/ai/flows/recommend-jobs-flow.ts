...
const extractionPrompt = g.extractJobCriteriaPrompt || ai.definePrompt({
...
g.extractJobCriteriaPrompt = extractionPrompt;

// Main flow logic
const recommendJobsFlow = g.recommendJobsFlow || ai.defineFlow(
  {
...
g.recommendJobsFlow = recommendJobsFlow;
