...
interface EditAspirationsDialogProps {
    ...
    tempAspirations: Partial<CandidateProfile['aspirations'] & { educationRequirement?: string, languageRequirement?: string, yearsOfExperience?: string, specialConditions?: string[] }>;
    setTempAspirations: React.Dispatch<React.SetStateAction<Partial<CandidateProfile['aspirations'] & { educationRequirement?: string, languageRequirement?: string, yearsOfExperience?: string, specialConditions?: string[] }>>>;
    suggestionPrinciple: 'basicSalary' | 'fee' | 'realSalary' | null;
    setSuggestionPrinciple: React.Dispatch<React.SetStateAction<'basicSalary' | 'fee' | 'realSalary' | null>>;
    feeButtonText: string;
    handleSaveAspirations: () => void;
}
//
...
export const EditAspirationsDialog: React.FC<EditAspirationsDialogProps> = ({
    ...
    setTempAspirations,
    suggestionPrinciple,
    setSuggestionPrinciple,
    handleSaveAspirations
}) => {
    ...
    useEffect(() => {
        ...
        if (tempAspirations.career) {
            ...
            setTempAspirations(prev => ({ ...prev, job: '' }));
        } else {
    ...
    const handleVisaDetailChange = (value: string) => {
        ...
        setTempAspirations(prev => ({ ...prev, career: '', job: '' }));
    };
    ...
    const handleDateSelect = (date: Date | undefined) => {
        // setTempAspirations(prev => ({ ...prev, interviewDate: date ? format(date, 'yyyy-MM-dd') : '' }));
    };
                    ...
                    <div className="flex flex-col md:grid md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2 order-3">
                            ...
                            >
                                ...
                                >
                                    <SelectValue
                                        placeholder={!tempAspirations.career ? "Hãy chọn Ngành nghề mong muốn" : "Chọn công việc chi tiết"}
                                    />
                                </SelectTrigger>
                                <SelectContent>
                                        ...
                                        <div className="flex flex-wrap gap-1">
                                            {Array.isArray(tempAspirations.workLocation) && tempAspirations.workLocation.length > 0 ? (
                                                tempAspirations.workLocation.map(locSlug => (
                                                    <Badge key={locSlug} variant="secondary">
                        ...
                        <div className="space-y-2">
                            <div className="grid grid-cols-1 grid-rows-2 sm:grid-cols-2 gap-2">
                                ...
                                >
                                    ...
                                    {tempAspirations.fee ? (
                                        <div className="flex items-baseline gap-2">
                                            <span className="text-sm font-bold text-accent-green">{getFeeDisplayValue(tempAspirations.fee)} USD</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={value => setTempAspirations(prev => ({ ...prev, interviewLocation: value === 'all' ? '' : value }))}
                                >
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex items-center space-x-2">
                                    <Checkbox
                                        ...
                                        onCheckedChange={(checked) => setTempAspirations(prev => ({ ...prev, interviewDateType: checked ? 'flexible' : '' }))}
                                    />
                            ...
                            <div className="space-y-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={value => setTempAspirations(prev => ({ ...prev, gender: value === 'all' ? '' : value }))}
                                >
                            ...
                            {showTattooFilter && (
                                <div className="space-y-2">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={value => setTempAspirations(prev => ({ ...prev, tattooRequirement: value === 'all' ? '' : value }))}
                                    >
