...
import { CreateProfileDialogs } from '@/components/profile-creation-dialogs';
                ...
                <div className="mt-6 flex flex-wrap gap-4 justify-center">
                     <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                        ...
                        <DialogContent className="sm:max-w-2xl">
                           <CreateProfileDialogs onClose={() => setIsDialogOpen(false)} />
                        </DialogContent>
                    </Dialog>
                    <Button asChild>
            ...
            >
                <AccordionItem value="item-1" id="item-1" className={cn(
                 ...
                 <AccordionItem value="item-2" id="item-2" className="border rounded-lg border-b-0">
                    ...
                    <AccordionContent className="bg-background p-6 rounded-b-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                           {appliedJobs.map((job) => ( <JobCard key={job.id} job={job} showRecruiterName={false} showCancelApplication={true} cancelSuggestionMode={cancelSuggestionMode} onCancelApplication={() => {}} /> ))}
                        </div>
                    </AccordionContent>
                </AccordionItem>
