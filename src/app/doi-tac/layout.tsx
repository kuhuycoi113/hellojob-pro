...
const PartnerHeader = () => (
    <header className="sticky top-0 z-50 w-full border-b bg-background">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
            <Link href="/doi-tac" className="flex items-center gap-2">
                <span className="font-semibold text-lg">Partner Portal</span>
            </Link>
            <nav className="hidden md:flex items-center gap-6 text-sm">
                <Link href="/doi-tac" className="font-medium hover:text-primary transition-colors flex items-center gap-2"><LayoutDashboard/> Bảng điều khiển</Link>
