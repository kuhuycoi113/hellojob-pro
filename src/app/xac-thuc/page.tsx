...
const XacThucPage: React.FC = () => {
    useRedirect();
    return (
        <div className='h-[100vh] flex bg-secondary'>
            <AuthContent onOpenChange={() => { }}>
                <div className='flex flex-col space-y-1.5 sm:text-left mb-6 text-left'>
                    ...
                    <h1 className='font-semibold tracking-tight text-3xl font-headline'>Chào mừng bạn đến với HelloJob!</h1>
                    <p className='text-sm text-muted-foreground'>Tạo tài khoản để mở khóa tiềm năng sự nghiệp của bạn.</p>
                </div>
            </AuthContent>
        </div>
    );
